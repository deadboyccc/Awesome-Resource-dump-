...
A curated collection of intriguing books, courses, and resources for Computer Science, Mathematics, Productivity, and Fiction.

---

## 🎓 Top Free University Courses & Portals

### **Computer Science & Engineering**
* **[Harvard CS50: Introduction to Computer Science](https://pll.harvard.edu/course/cs50-introduction-computer-science)** (Harvard)  
    *The quintessential entry-level CS course. Engaging, challenging, and covers C, Python, SQL, and more.*
* **[MIT OpenCourseWare (OCW)](https://ocw.mit.edu/)** (MIT)  
